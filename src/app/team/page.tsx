    ...
    <div className="bg-white p-4 rounded-lg shadow-lg text-center transition duration-300 ease-in-out hover:shadow-xl hover:-translate-y-1">
      ...
      <p className="text-sm text-gray-500 mb-3">{member.studentId}</p>
        ...
        <div className="flex justify-center space-x-4 mt-3">
            <a href={member.githubLink} target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-black transition">
                <AiFillGithub size={24} /> 
            </a>
        
            <a href={member.portfolioLink} target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-black transition">
